...
- [ ] Put an info circle icon in the header which should open up a large modal with settings, about, and feedback sections. Settings will contain 'Delete Experiments' and 'Reset App' buttons, which will allow the user to delete experiments from a list or reset the entire app data. The about section will have info about the dev (me) and the feedback section will have a link to the GitHub repo and instructions for how to submit feedback and issues.
